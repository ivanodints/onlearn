...
public class AspectLogger {
    ...
    public void logBefore(JoinPoint joinPoint){
        logger.info("Log aspect triggered in Admin-E-Shop with joinPoint (before): {}", joinPoint.toString());
    }

    @After("getPointCut()")
    public void logAfter(JoinPoint joinPoint){
        logger.info("Log aspect triggered in Admin-E-Shop with joinPoint (after): {}", joinPoint.toString());
    }
