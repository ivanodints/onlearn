package ru.geekbrains.steps.findCategoryAndDeleteStep;
...
public class FindCategoryAndDelete {
    ...
    @And("^I find category as \"([^\"]*)\"$")
    public void iFindCategory(String category) throws Throwable {
        WebElement webElement = webDriver.findElement(By.id("search_pole"));
        webElement.sendKeys(category);
        Thread.sleep(1000);
    }

    @When("^I delete this category$")
    public void iDeleteCategory() throws Throwable {
        WebElement webElement = webDriver.findElement(By.id("delete_btn"));
        webElement.click();
        Thread.sleep(1000);
    }
